...
import { ArrowDownAZ, Bell, ChevronLeft, ChevronRight, ClipboardCheck, Download, ListFilter, ShieldCheck } from "lucide-react";
...
export function getTaskExportInput(statusFilter: TaskStatusFilter, sortOption: TaskSortOption) {
  return { status: statusFilter === "all" ? undefined : statusFilter, sort: sortOption };
}
...
export default function CompletionTasks() {
  ...
  const taskExportInput = useMemo(() => getTaskExportInput(statusFilter, sortOption), [statusFilter, sortOption]);
