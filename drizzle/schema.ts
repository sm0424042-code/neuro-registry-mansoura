...
export type RadiologicalInvestigation = { modality: "mri" | "ct" | "cta" | "mra" | "dsa" | "doppler" | "pet" | "spect" | "xray" | "other"; bodyRegion: "brain" | "spine" | "cranial_nerves" | "cerebral_vessels" | "temporal_arteries" | "peripheral_nerves" | "other"; keyFinding: string; lesionStatus: "present" | "absent" | "indeterminate" | "not_applicable"; reportReference?: string | null };
...
export type LaboratoryInvestigation = { testName: "thyroid_function" | "hba1c" | "uric_acid" | "lipid_profile" | "ck" | "b12_folate" | "electrolytes" | "inflammatory_markers" | "autoimmune_panel" | "esr_crp" | "hepatitis_screening" | "renal_profile" | "other"; resultStatus: "normal" | "abnormal" | "borderline" | "not_done" | "unknown"; resultSummary?: string | null };
